...
public enum SpellEnum {
    ...
    VERDANT_SPORES(Material.LEATHER_HORSE_ARMOR, "Verdant Spores", "lime", "BLAST", 0),
    POISON_DARTS(Material.WOODEN_HOE, "Poison Darts", "lime", "MULTI_PROJECTILE", 125),
    AUTUMN_WINDS(Material.WOODEN_SHOVEL, "Autumn Winds", "lime", "AREA_OF_EFFECT", 150),
    VINE_GRAB(Material.JUNGLE_SAPLING, "Vine Grab", "lime", "TRANSPORT", 175),
    NATURES_AEGIS(Material.LIME_SHULKER_BOX, "Natures Aegis", "lime", "SHIELD", 200),
    SERRATED_EARTH(Material.MOSSY_COBBLESTONE_WALL, "Serrated Earth", "green", "BLAST", 0),
    LANDSLIDE(Material.COARSE_DIRT, "Landslide", "green", "MULTI_PROJECTILE", 200),
    BURROW(Material.STONE_PICKAXE, "Burrow", "green", "TRANSPORT", 300),
    SEISMIC_SMASH(Material.STONE_AXE, "Seismic Smash", "green", "CONTACT", 400),
    ROCK_BODY(Material.NETHERITE_CHESTPLATE, "Rock Body", "green", "AURA", 500),
    LIGHTNING_BOLT(Material.LIGHT_BLUE_GLAZED_TERRACOTTA, "Lightning Bolt", "cyan", "BLAST", 0),
    FLASH(Material.TIPPED_ARROW, "Flash", "cyan", "TRANSPORT", 200),
    SEISMIC_SHOCK(Material.DIAMOND_SHOVEL, "Seismic Shock", "cyan", "AREA_OF_EFFECT", 300),
    LIGHTNING_CHAIN(Material.DIAMOND_HOE, "Lightning Chain", "cyan", "MULTI_PROJECTILE", 400),
    GALVANISE(Material.DIAMOND_CHESTPLATE, "Galvanise", "cyan", "AURA", 500),
    ...
    METEOR_BELT(Material.STONE_HOE, "Meteor Belt", "light_gray", "MULTI_PROJECTILE", 0),
    BLACK_HOLE(Material.DRAGON_EGG, "Black Hole", "light_gray", "BLAST", 400),
    STELLAR_SLAM(Material.QUARTZ, "Stellar Slam", "light_gray", "TRANSPORT", 600),
    AETHERS_WRATH(Material.STONE_SHOVEL, "Aethers Wrath", "light_gray", "AREA_OF_EFFECT", 800),
    COSMIC_SMASH(Material.STONE_AXE, "Cosmic Smash", "light_gray", "CONTACT", 1000),
    SCATTER_BONES(Material.BONE, "Scatter Bones", "purple", "MULTI_PROJECTILE", 0),
    SOUL_DRAIN(Material.FLINT_AND_STEEL, "Soul Drain", "purple", "CONTACT", 400),
    SEEKING_SKULL(Material.PLAYER_HEAD, "Seeking Skull", "purple", "BLAST", 600), //TODO player head needs texture
    GASHING_FOSSILS(Material.BONE_BLOCK, "Gashing Fossils", "purple", "AREA_OF_EFFECT", 800),
    PHANTOMS_CURSE(Material.ELYTRA, "Phantoms Curse", "purple", "TRANSPORT", 1000),
