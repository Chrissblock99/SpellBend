...
public enum ElementEnum {
    EMBER(Material.FIRE_CHARGE, "<red><bold>Ember",
    ...
    WATER(Material.WATER_BUCKET, "<blue><bold>Water",
    ...
    NATURE(Material.OAK_SAPLING, "<green><bold>Nature",
    ...
    EARTH(Material.COARSE_DIRT, "<dark_green><bold>Earth",
    ...
    ELECTRO(Material.BEACON, "<aqua><bold>Electro",
    ...
    ICE(Material.PACKED_ICE, "<white><bold>Ice",
    ...
    AETHER(Material.NETHER_STAR, "<gray><bold>Aether",
    ...
    SOUL(Material.SKELETON_SKULL, "<dark_purple><bold>Soul",
    ...
    TIME(Material.CLOCK, "<yellow><bold>Time",
    ...
    METAL(Material.IRON_INGOT, "<#808080><bold>Metal",
    ...
    EXPLOSION(Material.TNT, "<gold><bold>Explosion",
    ...
    ElementEnum(@NotNull Material material, @NotNull String miniMessageName, @NotNull SpellEnum[] spells, int price, @NotNull String... miniMessageExplanation) {
        this.displayItem = new ItemBuilder(material)
                .setMiniMessageDisplayName(miniMessageName)
                .setMiniMessageLore(miniMessageExplanation)
                .hideAllFlags()
                .build();
