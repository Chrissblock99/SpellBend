...
public class Item {
    ...
    public static @NotNull ItemStack create(@NotNull Material material, @NotNull Component name, @NotNull NamespacedKey[] key, @NotNull String[] customData)
    {return create(material, name, 0, key, customData);}
    public static @NotNull ItemStack create(@NotNull Material material, @NotNull Component name, @NotNull HashMap<NamespacedKey, String> persistentData)
    ...
    public static @NotNull ItemStack create(@NotNull Material material, @NotNull Component name, @NotNull Component[] lore, @NotNull NamespacedKey[] key, @NotNull String[] customData)
    {return create(material, name, lore, 0, key, customData);}
    public static @NotNull ItemStack create(@NotNull Material material, @NotNull Component name, @NotNull Component[] lore, @NotNull HashMap<NamespacedKey, String> persistentData)
    ...
    public static @NotNull ItemStack create(@NotNull Material material, @NotNull Component name, int CustomModelData, @NotNull HashMap<NamespacedKey, String> persistentData) {
        ItemStack item = new ItemStack(material);
        ItemMeta meta = item.getItemMeta();
        PersistentDataContainer data = meta.getPersistentDataContainer();
    ...
    public static @NotNull ItemStack create(@NotNull Material material, @NotNull Component name, @NotNull Component[] lore, int CustomModelData, @NotNull HashMap<NamespacedKey, String> persistentData) {
        ItemStack item = new ItemStack(material);
        ItemMeta meta = item.getItemMeta();
        PersistentDataContainer data = meta.getPersistentDataContainer();
